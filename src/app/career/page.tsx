                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Work on cutting-edge technologies and challenging
                          projects that make a real impact in various
                          industries.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          ...
                          with flexible work arrangements and supportive
                          policies.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          ...
                          programs, and clear career advancement paths for all
                          employees.
                        </p>
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                    At Aegitek, we foster a culture of innovation,
                    collaboration, and continuous learning. We believe that
                    great ideas can come from anywhere, and we encourage our
                    team members to think creatively and take initiative.
                  </p>
                  <p className="text-lg text-gray-700 mb-6">
                    We celebrate diversity and inclusion, recognizing that
                    different perspectives lead to better solutions. Our team
                    members come from various backgrounds and bring unique
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white w-fit border-[1px] border-slate-200 shadow-md rounded-2xl p-6 mb-6 hover:shadow-xl transition duration-300">
                ...
                <p className="text-gray-600 mb-1">
                  <span className="font-semibold">Experience:</span> 3 – 7 Years
                </p>
                <p className="text-gray-600 mb-4">
                  <span className="font-semibold">Openings:</span> 1
                </p>
                <div className="text-sm text-gray-400">
                  © 2021 ASPL - All Rights Reserved
                </div>
              </div>
